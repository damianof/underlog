...
(function(v, s) {
  (function(n, a) {
    ...
    var n = 1e3, a = 6e4, h = 36e5, g = "millisecond", d = "second", y = "minute", b = "hour", M = "day", D = "week", w = "month", F = "quarter", x = "year", H = "date", U = "Invalid Date", q = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, Q = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, K = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(o) {
      ...
      return { M: w, y: x, w: D, d: M, D: H, h: b, m: y, s: d, ms: g, Q: F }[o] || String(o || "").toLowerCase().replace(/s$/, "");
    }, u: function(o) {
      return o === void 0;
    } }, C = "en", j = {};
    j[C] = K;
    var G = "$isDayjsObject", B = function(o) {
    ...
    return $.prototype = R, [["$ms", g], ["$s", d], ["$m", y], ["$H", b], ["$W", M], ["$M", w], ["$y", x], ["$D", H]].forEach(function(o) {
      R[o[1]] = function(r) {
        return this.$g(r, o[0], o[1]);
      };
    }), $.extend = function(o, r) {
      return o.$i || (o(r, W, $), o.$i = !0), $;
    }, $.locale = E, $.isDayjs = B, $.unix = function(o) {
      return $(1e3 * o);
    }, $.en = j[C], $.Ls = j, $.p = {}, $;
  });
})(V);
...
class ce extends J {
  ...
  async write(n) {
    return new Promise((a) => {
      ...
      let M = !1;
      if (le() && (M = /chrome/gi.test(`${navigator.userAgent || ""}`)), g !== "log" && M) {
...
class de {
  ...
  initLevels(s) {
    const n = s || [];
    n.length > 0 ? this.supportedLevels = Object.freeze([...n]) : this.supportedLevels = Object.freeze([...Z]);
  }
  initTransports(s) {
